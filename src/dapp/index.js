...
(async () => {
    ...
    let contract = new Contract('localhost', () => {
        ...
        let flightsName = ['Coblxck023', 'Coblxck897', 'Coblxck352', 'Coblxck034', 'Coblxck768'];
        let flights = {
            'Coblxck023': [date.getTime() + 1023, contract.airlines[0]],
            'Coblxck897': [date.getTime() + 2897, contract.airlines[1]],
            'Coblxck352': [date.getTime() + 3352, contract.airlines[2]],
            'Coblxck034': [date.getTime() + 4034, contract.airlines[3]],
            'Coblxck768': [date.getTime() + 5768, contract.airlines[4]]
        }
